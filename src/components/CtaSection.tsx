          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-2/3">
              ...
              <p className="text-gray-300 mb-6 max-w-xl">
                Join countless industries leveraging Kutty Brothers’ services — from fabrication and IBR components to tool rentals and transport solutions. Start improving efficiency today.
              </p>
